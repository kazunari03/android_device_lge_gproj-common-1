...
public class LgeLteRIL extends RIL implements CommandsInterface {
    ...
    private static final String LOG_TAG = "LgeLteRIL";
    ...
    responseIccCardStatus(Parcel p) {
        ...
        if (mPhoneType == RILConstants.CDMA_PHONE &&
            ...
            Log.d(LOG_TAG, "This is a CDMA PHONE index:" + appIndex);
        } else {
            appIndex = status.mGsmUmtsSubscriptionAppIndex;
            Log.d(LOG_TAG, "This is a GSM PHONE index:" + appIndex);
        }
    ...
    public void setCurrentPreferredNetworkType() {
        ...
        Log.d(LOG_TAG, "Called setCurrentPreferredNetworkType()");
   ...
   @Override
    public void setPreferredNetworkType(int networkType , Message response) {
        ...
        if (!mUSIM && networkType == RILConstants.NETWORK_MODE_LTE_GSM_WCDMA &&
            ...
            Log.d(LOG_TAG, "now netoworkType is RILConstants.NETWORK_MODE_WCDMA_PREF");

        }
        mSetPreferredNetworkType = networkType;

        Log.d(LOG_TAG, "Called setPreferredNetworkType(" + mSetPreferredNetworkType + ")");
    ...
    processUnsolicited (Parcel p) {
        ...
        int response = p.readInt();
         ...
         //Log.d(LOG_TAG, "processUnsolicited response = " + response);
        ...
        switch(response) {
            case RIL_UNSOL_RESPONSE_RADIO_STATE_CHANGED: ret =  responseVoid(p); break;  // もともとコメントされている
        ...
        switch(response) {
            case RIL_UNSOL_RESPONSE_RADIO_STATE_CHANGED:
                Log.d(LOG_TAG, "RIL_UNSOL_RESPONSE_RADIO_STATE_CHANGED");
                int state = p.readInt();
                setRadioStateFromRILInt(state);
                break;
            case RIL_UNSOL_RIL_CONNECTED:
                Log.d(LOG_TAG, "RIL_UNSOL_RIL_CONNECTED");
    ...
    private void setRadioStateFromRILInt (int stateCode) {
        ...
        switch (stateCode) {
            case RIL_INT_RADIO_OFF:
                 Log.d(LOG_TAG, "RIL_INT_RADIO_OFF");
            ...
            case RIL_INT_RADIO_ON_HTC:
                 Log.d(LOG_TAG, "RIL_INT_RADIO_ON");
                if (mIccHandler == null) {
                ...
                case EVENT_GET_ICC_STATUS_DONE:
                    ...
                    if (status.mApplications == null || status.mApplications.length == 0) {
                        ...
                        if (mPhoneType == RILConstants.CDMA_PHONE &&
                               status.mCdmaSubscriptionAppIndex >= 0) {
                            appIndex = status.mCdmaSubscriptionAppIndex;
                            Log.d(LOG_TAG, "IccHandler: This is a CDMA PHONE " + appIndex);
                        } else {
                            appIndex = status.mGsmUmtsSubscriptionAppIndex;
                            Log.d(LOG_TAG, "IccHandler: This is a GSM PHONE " + appIndex);
                        }
                        ...
                        switch (app_state) {
                            ...
                            case APPSTATE_PUK:
                                ...
                                break;
                            case APPSTATE_READY:
                                Log.d(LOG_TAG, "IccHandler: APPSTATE_READY");
                                switch (app_type) {
                                    case APPTYPE_SIM:
                                    case APPTYPE_USIM:
                                    case APPTYPE_RUIM:
